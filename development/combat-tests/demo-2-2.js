...
try{
  ...
  new Tier2BossCombatApp({root:document.querySelector('#game-screen'),scenario,progressRows,brandHref:'../combat-test-index.html',demoLabel:'Demo 2-2 / Region 2 Limit',resultContent:result,skillPageSize:1,passivePageSize:1});

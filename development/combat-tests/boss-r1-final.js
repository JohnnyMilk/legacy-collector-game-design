import {BossCombatApp} from './combat-boss-app.js?v=20260830-1324';
...
function result(model){return model.result==='victory'?{title:'Victory',lines:['Region 1 Boss 與 2 名 Tier 1 遺跡侍者擊破。','請以戰鬥體感判斷 Tier 1 隊伍面對治療支援與 Boss 的壓力。']}:{title:'Party Wipe',lines:['四名 Tier 1 主角全滅。','保留此結果作為 Region 1 Boss + 治療支援強度測試紀錄。']}}

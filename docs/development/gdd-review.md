...
- Tier 3 不使用共通 Mastery 模板；**只圍繞該職業自身的 Tier 3 專屬主動技能與專屬被動技能設計 Mastery**，不加入戰鬥場次、擊殺數或 Elite / Boss 參與等共通任務，項目數不固定。
...
- 僅移動代表移動後直接結束自身行動；僅行動代表普通攻擊／主動技能後直接結束自身行動。兩者都只是「結束行動」，**不等於 Wait 指令**；一般移動不可拆成行動前後兩段。
- Wait 必須由角色明確選擇，且該次自身行動沒有移動、普通攻擊或主動技能。只有真正執行 Wait 才能觸發綁定 Wait 的被動、遺產或其他效果。
...
- 吟遊詩人「休止」只在吟遊詩人明確選擇 Wait 指令時觸發；僅移動或僅行動後結束回合都不算 Wait，因此不會觸發回血。
...
- Tier 3 最外圈已建立 16 個概念節點的名稱、職業定位與明確 Inspiration Links；**軍團守衛已完成逐職業確認並成為第一個 `CONFIRMED` Tier 3**，其餘節點仍為 provisional。
- 目前 Tier 3 節點依角度排列為：戰地調律師、軍團守衛、血煉騎士、戰將、獵刃武者、獵首者、影獵者、疾影者、影刃術士、幻刃魔導士、刻刃術師、咒印魔導師、聖咒術師、戰場賢者、聖歌咒師、調律賢者。
- Tier 3 職業方向必須優先從所連結 Tier 2 已有主／被動技能推導；但正式設計不能只把前置職業能力平鋪並列，必須形成自己的戰術核心。
- **軍團守衛**：Inspiration Links 為騎士、吟遊詩人、煉金術士；定位為前線戰術核心／區域封鎖／隊伍保護。一般攻擊「戰槍」可攻擊前方連續 2 格；專屬主動「盾牆陣」為 3 Charge，在 4 個斜角嘗試生成 HP 1、不可穿越的盾牆；專屬被動「壁壘陣」讓軍團守衛鄰近的自有盾牆向周圍 8 格提供 DEF / MDEF +20% 防護，重疊不疊加，完整 4 牆可形成最大 5×5 防區。
- **軍團守衛 Mastery**：單次「盾牆陣」成功生成 4 面盾牆 15 次；由「壁壘陣」防護中的我方單位實際承受敵方傷害 30 次。兩項皆直接驗證 Tier 3 專屬技能，不含共通戰鬥／擊殺任務。
...
- 逐一確認其餘 Tier 3 的正式名稱、定位與 Inspiration Links
- 其餘 Tier 3 各職業一般攻擊
- 其餘 Tier 3 各職業 Charge 3 專屬主動技能
- 其餘 Tier 3 各職業專屬被動技能
- 其餘 Tier 3 專屬技能型 Mastery
...
Tier 1 與 Tier 2 維持已完成一致性審核的穩定基準。Tier 3 已進入逐職業正式設計階段；軍團守衛為第一個完成名稱、定位、一般攻擊、專屬被動、Charge 3 主動與技能型 Mastery 的 `CONFIRMED` Tier 3，其餘 15 個概念節點依序調整。

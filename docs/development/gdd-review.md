...
- 魔劍士職業玩法 Mastery 改為「在同一場戰鬥中，先造成物理傷害，再造成魔法傷害」；目標維持 12 次，判定範圍限於單一戰鬥，完整事件每觸發 1 次即累積 1 次。
- 巫師「魔力刻印」的順序固定為：先依命中前既有刻印層數完成傷害結算，再新增 1 層刻印，最多 2 層。
...
- Tier 1 與目前全部 Tier 2 職業已完成一輪全職業一致性審核；現有職業資料均為 `CONFIRMED`。
...
Tier 1 與目前 Tier 2 已完成第一輪全職業一致性審核。現行核心規格統一為：「戰鬥事件同時更新本次遠征紀錄與職業戰績檔案 → Mastery 門檻即時完成 → 戰後判定 MASTERED → 轉職與解鎖沿既定規則進行 → Run 結束由本次遠征紀錄生成遠征報告與稱號」。
